...
public class EditCustomer extends EditContentPanel {
	...
	public boolean bindToGUI(Object o) {
		...
		txtCreditLimit.setText(String.valueOf(c.getCreditLimit()));
		txtCurrentCredit.setText(String.valueOf(c.getCurrentCredit()));
		return true;
	}
	...
	public Object guiToObject() {
		...
		return new Customer(txtCode.getText(), txtName.getText(),
				txtAddress.getText(), txtPhone1.getText(), txtPhone2.getText(),
				Double.valueOf(txtCreditLimit.getText()),
				Double.valueOf(txtCurrentCredit.getText()));
	}
