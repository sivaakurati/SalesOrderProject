...
public class EditContainer extends JPanel implements ActionListener,
		HasBusinessPresenter {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (actionCommand.equals(SAVE_ACTION)) {
			...
			try {
				...
				JOptionPane
						.showMessageDialog(this, "Record Saved Successfully");
				goToHome();
			...
			boolean retValue = Services.deleteRecordByCode(
					editPanel.getCurrentCode(), objectType);
			if (retValue) {
				goToHome();
